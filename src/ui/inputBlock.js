// Whether a blocking popup (SAVE menu, settings menu, summary key viewer,
// the automatic phase-save reminder, the auto-save-detected offer, the
// hidden dev phase-jump GUI, the phone-mode layout editor, or the gamespeed
...
export function isInputBlocked(){
  return document.getElementById('save-menu').classList.contains('show')
    || document.getElementById('settings-menu').classList.contains('show')
